							...
							bool debug)
{
	...
	{	
		...
		// if(debug)
		// 	printf("id:%u, parent:%u, level:%u\n", id, parent[id], level[id]);
		// if(id == 2342229 || id == 11254902)
		// 	if(parent[id]!= PARENT_INFINITY)
		// 		printf("id:%u, parent:%u, level:%u, parent's level:%u, parent's parent:%u\n", id, parent[id], level[id], level[parent[id]], parent[parent[id]]);
...
// 		// if(debug)
// 		// 	printf("prop: id:%u, parent:%d, level:%u\n", id, parent[id], level[id]);
// 		// if(id == 2342229 || id == 11254902)
// 		// 	if(parent[id]!= PARENT_INFINITY)
// 		// 		printf("prop: id:%u, parent:%u, level:%u, parent's level:%u, parent's parent:%u\n", id, parent[id], level[id], level[parent[id]], parent[parent[id]]);
...
// 					// unsigned int newDist = dist[id] + edgeList[i].w8;
// 					// if(newDist < dist[dst])
// 					// {				
// 					// 	dist[dst] = newDist;
