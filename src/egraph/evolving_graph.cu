...
void Evolving_Graph<E, EL, DL>::ReadGraph(bool fileContainsWeight, int seed)
{
	...
	max_partition_size = 0.9 * (dev.totalGlobalMem - 16 * 4 * num_nodes) / sizeof(E);
	...
	label1 = new bool *[numSnapshots + 1];
	label2 = new bool *[numSnapshots + 1];

	value = new uint*[numSnapshots +1];
